...
<template>
  <div class="w-full h-14 px-4 pt-2 sticky top-0 bg-gray-50 z-20">
    <div
        ...
        <div class="flex items-center">
          <template v-if="weatherData">
            <SnowIcon
              ...
              class="text-blue-500 w-4 h-4 mx-2"
            />
            <RainIcon
              v-else-if="weatherData.weather[0].main === 'Rain'"
              class="text-blue-500 w-4 h-4 mx-2"
            />
            <CloudIcon
              v-else-if="weatherData.weather[0].main === 'Clouds'"
              class="text-blue-500 w-4 h-4 mx-2"
            />
