...
<template>
  <div
    class="max-w-lg mb-8 overflow-y pb-1 md:max-w-lg max-h-96 mr-5 md:mx-auto my-2"
  >
    ...
    >
      <swiper-slide>
        <img class="h-72 w-5/5 mx-auto rounded-xl" :src="hero?.listImage" />
      </swiper-slide>
      <swiper-slide>
        <img
          class="h-72 w-5/5 mx-auto rounded-xl"
          src="https://i.guim.co.uk/img/media/936ffea3d696c9c42ad1741fc755542c0f1eb576/0_0_5700_3420/master/5700.jpg?width=1200&quality=85&auto=format&fit=max&s=f104a75e0cf7a96baa06e02f23003e24"
        />
      </swiper-slide>
      <swiper-slide>
        <img
          class="h-72 w-5/5 mx-auto rounded-xl"
          src="https://i.ytimg.com/vi/Yhu45tigIsI/maxresdefault.jpg"
        />
      </swiper-slide>
      <swiper-slide>
        <img
          class="h-72 w-5/5 mx-auto rounded-xl"
          src="https://www.fischerblog.com/gb/wp-content/uploads/sites/12/2019/09/1200x827-Tottenham-Stadion-2.jpg"
      /></swiper-slide>
    </swiper>
    ...
    <div class="flex items-center mt-4 justify-center">
      <div>
        <input
          v-model="booking"
          class="border-2 border-teal-500 rounded-l-xl px-6 py-3 -none text-lg"
          v-maska
          data-maska="+998(##) ###-##-##"
      ...
      <button
        class="bg-teal-500 hover:bg-teal-600 transition duration-300 text-white font-semibold px-8 py-4 rounded-r-xl"
      >
        Book Now
      </button>
    </div>
