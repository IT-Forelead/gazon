...
<template>
  <div class="max-w-lg px-1 pb-1 md:max-w-lg    mx-auto md:mx-auto">
    ...
    <div class="flex mt-2 space-x-2">
      ...
      <p class="text-md  ">{{hero?.Item}} Xorazm Palace 24-son maktab yoni </p>
    </div>
    <div class=" " >
      <iframe class="rounded-2xl my-3.5 mx-auto h-56 w-4/5 "  src="https://yandex.ru/map-widget/v1/?um=constructor%3A0861d5d052d7a68acfd29d258e16d301bf0474c689e21cece960b0f2abbbaedc&amp;source=constructor"  frameborder="0"></iframe>
    </div>
    ...
    <div class="flex justify-around  mb-3 mt-2  text-center items-center">
      ...
      <button class="border-2 px-6 py-2 bg-teal-200 border-teal-200 hover:bg-teal-100 transition duration-300 rounded-xl">
