...
<template>
  <div class="max-w-lg md:mx-auto mt-10">
    <div class="flex items-center justify-around">
      ...
      <button @click="useModalStore().openSearchMatchListModal()">
        <SearchIcon
          class="w-7 h-7 text-teal-600 hover:text-teal-500 cursor-pointer mx-2"
        />
      </button>
      <SearchMatchListModal />
      <button @click="useModalStore().openFilterMatchListModal()">
        <FilterIcon
          class="w-7 h-7 text-teal-600 hover:text-teal-500 cursor-pointer mx-2"
        />
      </button>
    ...
    <div>
      <ul
        class="flex justify-center text-white bg-gray-50 mx-2 py-2 mt-4 rounded-lg"
      >
        <li>
          <button
            ...
            :class="{
              'bg-teal-500 text-white': tab === 'todays',
              'bg-white text-teal-500': tab !== 'todays',
            }"
          >
            Today's Matches
          </button>
        ...
        <li>
          <button
            ...
            class="inline-block md:px-12 px-6 py-2 focus:outline-none rounded-lg mx-1"
            :class="{
              'bg-teal-500 text-white': tab === 'finished',
              'bg-white text-teal-500': tab !== 'finished',
            }"
          >
            Finished Matches
          </button>
      ...
      <div class="p-3 mt-4 mb-14 flex justify-center">
        <div v-if="tab === 'todays'">
          ...
          >
            ...
            <div class="flex mt-3">
              ...
              <div
                class="flex items-center w-full font-bold justify-center text-teal-600 p-1.5 border-y text-xl"
              >
                {{ match.time }}
              </div>
              <div
            ...
            <div
              class="flex justify-center items-center text-teal-600 my-4 text-sm"
            >
        ...
        <div v-if="tab === 'finished'">
          <div
            v-for="(matches, index) in finishedMatches"
            :key="index"
            class="w-[380px] px-4 h-[180px] pb-1 bg-white rounded-lg shadow-lg border mb-3"
          >
            ...
            <div class="flex mt-2">
              ...
              <div
                class="flex items-center w-full justify-center font-bold text-teal-600 p-1.5 border-y text-xl"
              >
                {{ matches.score }}
              </div>
              <div
            ...
            <div
              class="flex justify-center items-center text-red-600 my-1 text-sm"
            >
              Tugadi
            </div>
