...
<template>
  <div class="max-w-lg md:mx-auto mt-10">
    <div class="flex items-center justify-around">
      ...
      <h1 class="font-bold text-teal-600 text-lg flex-grow text-center pl-7">Match list</h1>
      <button @click="useModalStore().openSearchMatchListModal()">
        <SearchIcon class="w-7 h-7 text-teal-600 hover:text-teal-500 cursor-pointer mx-2"/>
      </button>
      <SearchMatchListModal/>
       <button @click="useModalStore().openFilterMatchListModal()">
         <FilterIcon class="w-7 h-7 text-teal-600 hover:text-teal-500 cursor-pointer mx-2"/>
       </button>
